...
class JellyFishFlowers {
    constructor() {
        ...
        this.landCoverage = 0.20;
        this.totalNumber = (this.drawingArea.end_x - this.drawingArea.start_x) * this.landCoverage / JellyFishFlowerModel.defaultWidth;
        JellyFishFlowersController.instance.generateModels(this.drawingArea, this.totalNumber);
    }
    static get instance() {
        if (!this._instance)
            this._instance = new JellyFishFlowers();
    ...
    draw() {
        const visibleModels = BufferedRenderer.instance.getVisibleMovableModels(JellyFishFlowersController.instance.models);
