class FlowerClouds {
    private readonly totalNumber = (Configuration.instance.totalSceneWidth * Configuration.instance.sceneHeight) / 200000;
    ...
    private static _instance: FlowerClouds;

    public static get instance(): FlowerClouds {
        if (!this._instance) this._instance = new FlowerClouds();
        return this._instance;
    }

    private static applyOpacityToColor(mColor: string, opacity: number) {
    ...
    public draw(): void {
        const visibleModels = BufferedRenderer.instance.getVisibleMovableModels<FlowerCloudModel>(FlowerCloudsController.instance.models);
