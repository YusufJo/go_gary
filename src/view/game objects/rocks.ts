class Rocks {
    ...
    private static _instance: Rocks;

    public static get instance(): Rocks {
        if (!this._instance) this._instance = new Rocks();
        return this._instance;
    }

    private static rockFill() {
        push();
