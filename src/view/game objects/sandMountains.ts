class SandMountains {
    ...
    private readonly landCoverage = 0.6;
    private readonly totalNumber = (this.drawingArea.end_x - this.drawingArea.start_x) * this.landCoverage / SandMountainModel.defaultWidth;

    private constructor() {
        SandMountainsController.instance.generateModels(this.drawingArea, this.totalNumber);
    }

    private static _instance: SandMountains;

    public static get instance(): SandMountains {
        if (!this._instance) this._instance = new SandMountains();
        return this._instance;
    }

    private static drawBaseBody(): void {
        push();
    ...
    private static mountainBodyLayer(): void {
        push();
        beginShape();
        vertex(-132.4, -1);
    ...
    private static drawBodyShader(): void {
        push();
    ...
    public draw(): void {
        const visibleModels = BufferedRenderer.instance.getVisibleMovableModels<SandMountainModel>(SandMountainsController.instance.models);
